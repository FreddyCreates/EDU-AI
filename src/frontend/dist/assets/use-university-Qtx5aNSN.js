import { i as createLucideIcon, f as useActor, h as createActor } from "./index-BivnQ6bB.js";
import { a as useQuery } from "./query-8urnerR0.js";
import { r as reactExports } from "./vendor-1quNMNNh.js";
/**
...
const COURSES = [
  ...
  },
  {
    ...
    description: "Wire agents across substrates with protocol-enforced couplings",
    modules: 13,
    requiredSss: 13,
    requiredSssThreshold: 13,
    order: 6,
  ...
  },
  {
    ...
    description: "Blueprint reading, construction math, OSHA safety, material science — compete-ready prep",
    modules: 8,
    requiredSss: 5,
    requiredSssThreshold: 5,
    order: 9,
  ...
  },
  {
    ...
    description: "Number theory, geometry, algebra — systematic competition prep through Fibonacci milestone sessions",
    modules: 8,
    requiredSss: 5,
    requiredSssThreshold: 5,
    order: 10,
  ...
  },
  {
    id: "uil-science",
    title: "UIL Science",
    description: "Physics, chemistry, biology — multi-path sovereign prep with EDDI as your guide",
    modules: 8,
    requiredSss: 5,
    requiredSssThreshold: 5,
    order: 11,
  ...
  },
  {
    ...
    description: "Marketing, finance, business planning — full role-play prep with EDDI coaching each scenario",
    modules: 5,
    requiredSss: 5,
    requiredSssThreshold: 5,
    order: 12,
  ...
  },
  {
    ...
    description: "Sight-reading, chord construction, harmonic analysis — sovereign preparation for music competition",
    modules: 8,
    requiredSss: 8,
    requiredSssThreshold: 8,
    order: 13,
  ...
  },
  {
    ...
    description: "Sports physiology, nutrition, training theory — the academic side of athletic performance",
    modules: 5,
    requiredSss: 5,
    requiredSssThreshold: 5,
    order: 14,
...
function useEnrollInCourse() {
  ...
  const [enrolledIds, setEnrolledIds] = reactExports.useState([]);
  const [lastEnrollmentResult, setLastEnrollmentResult] = reactExports.useState(null);
...
export {
  ...
  useCourses as a,
  useUserAgents as b,
  useCourseDetail as c,
  useEnrollInCourse as u
};
